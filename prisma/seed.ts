...
const routes_seed = [
	{
		...
		locations: [
			...
			{
				location_name:
					"Russet St / Aquamarine St Intersection, Marikina City",
				latitude: 14.638774,
				longitude: 121.116335,
			},
			{
				location_name:
					"Russet St / Sapphire Street Intersection, Marikina City",
				latitude: 14.64016,
				longitude: 121.116834,
			},
			{
				location_name:
					"Bronze St / Rainbow St Intersection, Marikina City",
				latitude: 14.640695,
				longitude: 121.115954,
			},
			{
				location_name:
					"Azure St / Rainbow St Intersection, Marikina City",
				latitude: 14.64098,
				longitude: 121.114259,
			},
			{
				location_name:
					"Rainbow St Near J. M. Panganiban St Intersection, Marikina City",
				latitude: 14.64181,
			...
			{
				location_name:
					"General Ordoñez Ave / T. Bugallon St Intersection, Marikina City",
				latitude: 14.64842,
			...
			{
				location_name:
					"E Rodriguez Ave. / Bayan-Bayanan Avenue Intersection, Marikina City",
				latitude: 14.65096,
				longitude: 121.104149,
			},
			{
			...
			{
				location_name:
					"Aquilina St / E Rodriguez Ave. Intersection, Marikina City",
				latitude: 14.642541,
				longitude: 121.099799,
			},
			{
				location_name:
					"E Rodriguez Ave. / E Mendoza St Intersection, Marikina City",
				latitude: 14.640295,
			...
			{
				location_name:
					"Barangka - Marcos Hwy Intersection, A. Bonifacio Ave., Marikina City",
				latitude: 14.632222,
			...
			{
				location_name:
					"LRT-2 Katipunan/St. Bridget School, Aurora Blvd., Quezon City",
				latitude: 14.63098,
				longitude: 121.072422,
			},
			{
				location_name:
					"Asian College of Science and Technology, Aurora Blvd., Quezon City",
				latitude: 14.629305,
			...
			{
				location_name:
					"T.I.P Cubao, Aurora Blvd / 20th Avenue, Quezon City, Manila",
				latitude: 14.626521,
				longitude: 121.06054,
			},
			{
				location_name:
					"General Romulo Ave. / Aurora Blvd. Intersection, Quezon City",
				latitude: 14.623995,
				longitude: 121.055542,
			},
			{
				location_name:
					"Aurora Blvd / General Aguinaldo Ave Intersection / LRT 2 - Cubao Station, Quezon City",
				latitude: 14.622924,
				longitude: 121.053188,
			},
			{
				location_name:
					"Aurora Blvd / EDSA Avenue Intersection, Quezon City",
				latitude: 14.62172,
				longitude: 121.050275,
			},
			{
				location_name:
					"Aurora Blvd / N Domingo Intersection, Quezon City",
				latitude: 14.620046,
				longitude: 121.046044,
			},
			{
				location_name:
					"Aurora Blvd / Betty Go-Belmonte Intersection / LRT 2 - Betty Go Station, Quezon City",
				latitude: 14.618222,
				longitude: 121.042051,
			},
			{
				location_name:
					"Saint Paul University Of Quezon City, Aurora Boulevard Cor. Gilmore Avenue, Quezon City",
				latitude: 14.616891,
				longitude: 121.039998,
			},
			{
				location_name:
					"Doña M. Hemady Ave / Ramon Magsaysay Blvd Intersection, Quezon City",
				latitude: 14.615135,
				longitude: 121.037087,
			},
			{
				location_name:
					"Lrt-2 Gilmore Station, Aurora Blvd, Quezon City",
				latitude: 14.613345,
			...
			{
				location_name:
					"Aurora Blvd / LRT 2 - J. Ruiz Station, San Juan",
				latitude: 14.610846,
			...
			{
				location_name:
					"University of the East Ramon Magsaysay, Aurora Blvd , San Juan",
				latitude: 14.607574,
				longitude: 121.020512,
			},
			{
				location_name:
					"Santa Mesa Blvd/ LRT 2 - V.Mapa Station, Manila",
				latitude: 14.604273,
				longitude: 121.017107,
			},
			{
				location_name:
					"Magsaysay Blvd / V. Mapa Street Intersection, Manila",
				latitude: 14.603012,
				longitude: 121.01581,
			},
			{
				location_name:
					"V. Mapa Street  / Old Sta. Mesa St Intersection, Manila",
				latitude: 14.6002,
	...
	},
	{
		...
		locations: [
			...
			{
				location_name:
					"Aurora Blvd. - Asian College of Science and Technology",
				latitude: 14.62932,
				longitude: 121.06899,
			},
			{
			...
			{
				location_name:
					"Aurora Blvd. - Technological Institute of the Philippines (TIP)",
				latitude: 14.6268,
				longitude: 121.06118,
			},
			{
			...
			{
				location_name:
					"Gen. MacArthur Ave - Times Square Avenue - Araneta Cubao Bus Station",
				latitude: 14.62152,
				longitude: 121.05513,
			},
			{
	...
	},
	{
		...
		locations: [
			...
			{
				location_name:
					"Daang Bakal / C. A. Santos St Intersection, Marikina City",
				latitude: 14.641,
				longitude: 121.0942,
			},
			{
			...
			{
				location_name:
					"Roosevelt College, J. P. Rizal St., Marikina City",
				latitude: 14.6492,
				longitude: 121.0984,
			},
			{
			...
			{
				location_name:
					"J. P. Rizal cor. Bayan-Bayanan Ave., Marikina City",
				latitude: 14.6507,
				longitude: 121.1029,
			},
			{
				location_name:
					"J. P. Rizal St. cor. Bagong Farmers Ave., Tumana, Marikina City",
				latitude: 14.6528,
				longitude: 121.1032,
			},
			{
			...
			{
				location_name:
					"J. P. Rizal St / Egypt Street Intersection, Marikina City",
				latitude: 14.665,
				longitude: 121.1069,
			},
			{
				location_name:
					"J. P. Rizal St / Japan Avenue Intersection, Marikina City",
				latitude: 14.667,
				longitude: 121.1075,
			},
			{
	...
	},
	{
		...
		locations: [
			...
			{
				location_name:
					"Capitol 8/San Ignacio St., Pasig Blvd., Pasig City",
				latitude: 14.5675,
				longitude: 121.066,
			},
			{
			...
			{
				location_name:
					"Pineda/Rizal Medical Center, Pasig Blvd., Pasig City",
				latitude: 14.5636,
				longitude: 121.0654,
			},
			{
			...
			{
				location_name:
					"Eulogio Rodriguez Jr. Ave. / Danny Flo St, Pasig City",
				latitude: 14.5704,
				longitude: 121.0713,
			},
			{
			...
			{
				location_name:
					"Eulogio Rodriguez Jr. Ave. / Lanuza Ave., Pasig City",
				latitude: 14.5784,
				longitude: 121.0741,
			},
			{
			...
			{
				location_name:
					"Eulogio Rodriguez Jr Ave. / Doña Julia Vargas Ave. Intersection, Pasig City",
				latitude: 14.5825,
				longitude: 121.0769,
			},
			{
	...
	},
	{
		...
		locations: [
			...
			{
				location_name:
					"Sunset Drive Footbridge, Ortigas Avenue Extension, Cainta",
				latitude: 14.5837,
				longitude: 121.1237,
			},
			{
	...
	},
	{
		...
		locations: [
			{
				location_name:
					"EDSA Central Jeepney Terminal, Mandaluyong City",
				latitude: 14.5803,
				longitude: 121.0545,
			},
			{
			...
			{
				location_name:
					"Hong Kong Noodles & Dimsum, Shaw Blvd., Pasig City",
				latitude: 14.5756,
				longitude: 121.0602,
			},
			{
	...
	},
	{
		...
		locations: [
			...
			{
				location_name:
					"Blumentritt / Rizal Ave. Intersection, City of Manila",
				latitude: 14.6231,
				longitude: 120.9833,
			},
		],
	},
	{
		...
		locations: [
			...
			{
				location_name:
					"Immaculate Conception Academy, North Bay Blvd., City of Manila",
				latitude: 14.6242,
				longitude: 120.9678,
			},
			{
				location_name:
					"Manila Faith Assembly of God, Juan Luna, City of Manila",
				latitude: 14.6222,
				longitude: 120.9719,
			},
			{
				location_name:
					"Gagalangin Fire Station, Juan Luna, City of Manila",
				latitude: 14.6254,
				longitude: 120.973,
			},
			{
				location_name:
					"F. Benitez Elementary School, Juan Luna, Caloocan City",
				latitude: 14.6267,
				longitude: 120.9734,
			},
			{
	...
	},
	{
		...
		locations: [
			...
			{
				location_name:
					"Timog Ave. / Scout Santiago Intersection, Quezon City",
				latitude: 14.6361,
				longitude: 121.0294,
			},
			{
				location_name:
					"Scout Tobias / Timog Ave. Intersection, Quezon City",
				latitude: 14.6358,
				longitude: 121.031,
			},
			{
				location_name:
					"Timog Ave. / Scout Tuason Intersection, Quezon City",
				latitude: 14.6354,
				longitude: 121.0331,
			},
			{
			...
			{
				location_name:
					"Tomas Morato Ave. / Scout De Guia Intersection, Quezon City",
				latitude: 14.6313,
				longitude: 121.0345,
			},
			{
			...
			{
				location_name:
					"Judge Damien Jimenez / Kamuning Rd., Quezon City",
				latitude: 14.6287,
				longitude: 121.0386,
			},
			{
			...
			{
				location_name:
					"Kamuning Rd. / Scout Rallos Extension Intersection, Quezon City",
				latitude: 14.6305,
				longitude: 121.0452,
			},
			{
				location_name:
					"Kamias Rd. / Colonel Salgado Intersection, Quezon City",
				latitude: 14.631,
				longitude: 121.0468,
			},
			{
				location_name:
					"Kamias Rd. / Maliksi St Intersection, Quezon City",
				latitude: 14.6319,
				longitude: 121.0499,
			},
			{
			...
			{
				location_name:
					"Kamias Rd. / Kalayaan Ave. Intersection, Quezon City",
				latitude: 14.6333,
				longitude: 121.0545,
			},
			{
				location_name:
					"Kamias Rd. / Kasing-Kasing Intersection, Quezon City",
				latitude: 14.6339,
				longitude: 121.0566,
			},
			{
				location_name:
					"Kamias Rd. / Anonas Extension Intersection, Quezon City",
				latitude: 14.6342,
				longitude: 121.0589,
			},
			{
			...
			{
				location_name:
					"Don Quintin Paredes High School, Anonas, Quezon City",
				latitude: 14.6314,
				longitude: 121.0609,
			},
			{
	...
	},
	{
		...
		locations: [
			{
				location_name:
					"Senator Gil Puyat Ave. cor. Taft Ave., Lungsod ng Pasay",
				latitude: 14.5541,
				longitude: 120.9966,
			},
			{
